...
function processarDada(dada) {
	...
	+ dada.idVivienda +'</a></h4><p class="card-text"><strong>Anunci :</strong> '+ dada.anuncio 
	+'</p><p class="card-text"><strong>Tipus :</strong> '+ dada.tipo +'</p><p class="card-text"><strong>Ubicació</strong> : '
